...
define(function(require, exports, module) {
    ...
    var defaults = {
        ...
        //状态栏
        status: function(total, page, count,pageCount) {
            return total?'共 ' + total + ' 条数据':(pageCount ? "本页 " + pageCount + " 条数据":"");
        },
        //数据策略
    ...
    return function(config) {
        ...
        var loader = config.loader = UI.loader({
            ...
            afterLoad: function(data) {
                ...
                //如果返回了总数
                statubar.html(config.status(data.total, loader.page, loader.count,config.cache.length));

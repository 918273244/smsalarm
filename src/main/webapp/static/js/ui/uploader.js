...
define(function(require, exports, module) {
    ...
    var notify = require('ui/notify'),
        ...
        dialog = notify({
            ...
            msg: '<b class="b note ac-upload va-m m2">上传文件</b>' + (isChrome ? '<input type="file" webkitdirectory="" hidden><b class="b note ac-upload-folder va-m">上传文件夹</b>' : '') + '<div class="m1 scroll ac-showcase" style="height:250px;position:relative;border:solid 1px #e4e5e9;background:#FAFBFE"></div>',
            mask: true,
            width: 550,
            events: {
            ...
            handError: function(up, err) {
                if (err.code == -600) {
                    return '文件大小超过' + up.settings.filters.max_file_size ;
                }
                return err.message;
            },
            //国际化
            ...
            show: function(options) {
                ...
                options.footLabel && _t.footLabel.html(options.footLabel);
                //绑定上传插件
